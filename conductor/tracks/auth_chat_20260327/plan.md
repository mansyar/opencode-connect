...
- [ ] Task: Initialize Expo project with pnpm
- [ ] Task: Configure TypeScript strict mode
- [ ] Task: Install and configure Vitest
- [ ] Task: Install core dependencies (Tamagui, Zustand, expo-router)
...
- [ ] Task: Write tests for authStore
    - [ ] Test initial state
    - [ ] Test login with valid credentials
    - [ ] Test login failure handling
    - [ ] Test logout clears state
- [ ] Task: Implement authStore with Zustand
    - [ ] Define AuthStore interface
    - [ ] Implement login action with credential validation
